...
public class LoginController {
	...
	public String login(HttpSession sessoin, String nick) {
		//로그인할 때 정보를 받아서 세션에 저장하고 chat 창으로 보냄
		sessoin.setAttribute("nick", nick);
		return "chat";		
	}
	...
	public String naverLoginCallback(HttpServletRequest request) {
		...
		String clientId = "V0OtXCPZGwP6tRz8J7kB";
		String clientSecret = "gY23MdAQYN";
...
//				System.out.println(result);
				...
				Map<String, String> requestHeaders = new HashMap<String, String>(); // 헤더저장하려고 맵만듬
